export default {
  ...
  publisher_hub_docs_lead: 'Sao chép prompt AI (build/test), token session (quy tắc file local + .gitignore), hoặc URL tài liệu công khai.',
  publisher_hub_docs_path: 'Trong JSON: audiences.publisher.bridge và hosted_runtime_troubleshooting.',
  publisher_hub_docs_copy_prompt: 'Sao chép prompt AI',
