export default {
  ...
  publisher_hub_docs_lead: 'Tải hợp đồng publisher chính thức từ API Hub (GET công khai, không cần đăng nhập). Đọc trực tiếp hoặc đưa URL cho trợ lý AI / agent để biết cách tích hợp app với App Hub.',
  publisher_hub_docs_path: 'Trong JSON, mở audiences.publisher.bridge — launch, quyền manifest, api_urls, bridge HTTP và các bước đăng app.',
  publisher_hub_docs_copy: 'Sao chép URL cho AI',
