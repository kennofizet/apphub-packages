export default {
  ...
  mobile_enter_fullscreen: 'Vào toàn màn hình',
  mobile_exit_fullscreen: 'Thoát toàn màn hình',
  mobile_control_center: 'Trung tâm điều khiển',
  mobile_control_refresh: 'Làm mới',
  mobile_control_appearance: 'Giao diện',
  mobile_control_brightness: 'Độ sáng ứng dụng',
  mobile_control_on: 'Đang bật',
  mobile_control_off: 'Đang tắt',
  mobile_control_ready: 'Sẵn sàng',
  mobile_control_unread: 'chưa đọc',
  mobile_control_light: 'Sáng',
  mobile_control_dark: 'Tối',
  ...
  runner_demo_banner_hint: 'Parent bridge chỉ dùng dữ liệu demo — dữ liệu thật sau khi DEV duyệt phiên bản này.',
  ...
  hub_settings_pin_favorite_note: 'Click phải app trên desktop, menu Start hoặc thanh tác vụ để ghim, yêu thích hoặc bỏ.',
  ...
  hub_settings_keyboard_hint: 'Snap cửa sổ App Hub đang active, hoặc chuyển giữa các cửa sổ đang mở.',
  hub_settings_keyboard_browser_note: 'Phím Windows (⊞) + Tab / Alt + Tab / Ctrl + Alt + Tab / Alt + Space thuộc hệ điều hành hoặc trình duyệt. App Hub dùng Ctrl + Alt + mũi tên để snap và Ctrl + Alt + W để chuyển cửa sổ. Click desktop Hub trước (không click trong iframe app).',
  hub_settings_keyboard_enabled: 'Bật phím tắt Ctrl + Alt',
  hub_settings_keyboard_modifier_ctrl_alt: 'Ctrl + Alt',
  hub_settings_keyboard_modifier_note: 'Click desktop hoặc thanh tiêu đề cửa sổ Hub trước để App Hub có focus, rồi bấm phím tắt. Phím gõ trong iframe app hosted chỉ nằm trong app đó.',
  ...
  hub_settings_keyboard_switcher: 'Chuyển cửa sổ đang mở',
  ...
  window_switcher_title: 'Cửa sổ đang mở',
  window_switcher_empty: 'Không có cửa sổ nào',
  window_switcher_hint: 'Tab / mũi tên để chọn · Enter để mở · Esc để hủy',
  window_switcher_minimized: 'Thu',
  ...
  desktop_context_display_settings: 'Cài đặt hiển thị',
  desktop_context_snap_grid: 'Căn biểu tượng theo lưới',
  desktop_context_light_mode: 'Chế độ sáng',
  ...
  guide_dev_bridge_1: '1) User mở app → Hub gọi POST /apps/{slug}/launch (trả launch_token + expires_in + scopes_granted).',
  guide_dev_bridge_2: '2) Hub mở runtime và gửi apphub:bridge:ready (slug, launch_token, session_id, api bases, version, display_user). Khi cửa sổ còn mở, Hub làm mới launch_token ngắn và gửi lại ready — dùng token mới nhất nếu bạn cache.',
  guide_dev_bridge_3: '3) Dùng window.AppHubBridge hoặc lắng nghe apphub:bridge:ready. callParent trước khi DEV duyệt có thể trả demo (banner Demo); sau duyệt + mở lại mới có parent.* thật. Sao chép docs/sdk-stub.js nếu cần client sẵn.',
