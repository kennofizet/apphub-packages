export default {
  ...
  publisher_hub_docs_lead: 'Copy an AI prompt for build and test, copy your session token (local file + .gitignore rules), or copy the public docs URL.',
  publisher_hub_docs_path: 'Contract JSON path: audiences.publisher.bridge and hosted_runtime_troubleshooting.',
  publisher_hub_docs_copy_prompt: 'Copy AI prompt',
